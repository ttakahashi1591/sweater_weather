...
RSpec.describe "Munchies Endpoint" do
  it "will return the current forecast summary & temperature for the city specified as well as a restaurant in that city including details: name, address, rating, and reviews", :vcr do
